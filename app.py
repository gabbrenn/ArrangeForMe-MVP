...
def dash():
    if 'user' in session:
        ...
        return render_template('index.html',active_page='dash',useremail=user[2],username=user[1], tasks=tasks, today=todaytime)
    else:
        return redirect(url_for('sign_in'))
...
def upcoming():
    if 'user' in session:
        ...
        return render_template('upcoming.html',active_page='upcoming',useremail=user[2],username=user[1], tasks=tasks,today=todaytime)
    else:
        return redirect(url_for('sign_in'))
...
def team():
    if 'user' in session:
        ...
        return render_template('team.html',active_page='team',today=todaytime, useremail=user[2], username=user[1], mytasks=mytasks,othertasks=othertasks, task_id=task_id)
    else:
        return redirect(url_for('sign_in'))
